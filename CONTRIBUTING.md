...
If you use cpanminus, you can do it without downloading the tarball first:
    ...
    $ cpanm --reinstall --installdeps --with-recommends MooseX::StrictConstructor
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends MooseX::StrictConstructor
...
The code for this distribution is [hosted at GitHub](https://github.com/moose/MooseX-StrictConstructor).
